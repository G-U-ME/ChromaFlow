    ...
    >
      ...
      {savedColors.length > 0 && (
          ...
          >
             ...
             <div className={`absolute top-0 left-0 bottom-0 w-[2.5rem] sm:w-[3.5rem] rounded-[2rem] ${glassPanelClass} pointer-events-auto`} />

             {/* Scroll Container - Expands on Hover to avoid clipping children */}
             <div 
                ref={savedColorsListRef}
                className="relative max-h-[50vh] overflow-y-auto overflow-x-visible flex flex-col-reverse items-start py-2 pl-[0.5rem] sm:pl-[0.75rem] w-[2.5rem] sm:w-[2.5rem] scrollbar-hide transition-[width] duration-200 ease-out pointer-events-auto"
                style={{ 
