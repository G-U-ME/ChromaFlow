      ...
      {savedColors.length > 0 && (
        ...
        >
          ...
          <motion.div
            ...
            className={`relative max-h-[35vh] sm:max-h-[50vh] overflow-y-auto flex flex-col-reverse items-start py-2 px-2 scrollbar-hide pointer-events-auto rounded-[2rem] ${glassPanelClass} overflow-x-hidden`}
            style={{
              scrollbarWidth: 'none'
            }}
